...
<!-- end nav -->
 <div class="container"><h2 style="margin-top: 50px;  color : green;"><i class="fas fa-user-check"></i> les validations</h2>
...
<a href="ADliste-validation.php?delete=<?php echo $row["id"]?>"  class="btn btn-danger btn-sm"     onclick="clic()"><i class="fas fa-trash-alt"></i></a>

<a href="ADliste-validation.php?block=<?php echo $row["id"];?>&fullname=<?php echo $row["fullname"];?>
