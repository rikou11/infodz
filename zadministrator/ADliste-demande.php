...
<a href="ADliste-demande.php?delete=<?php echo $row["id"]; ?>"  class="btn btn-danger btn-sm"     onclick="clic()"><i class="fas fa-trash-alt"></i></a>
...
<script> function clic(){return confirm('Are you sure you want to valid user ?')
