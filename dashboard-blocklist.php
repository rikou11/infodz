...
<!-- end nav -->
 <div class="container"><h2 style="margin-top: 50px;  color : red;"> <i class="fas fa-exclamation-triangle"></i> liste des clients bloque</h2>
...
<td> 
<a href="dashboard-blocklist.php?deblocker=<?php echo $row["id"];  ?>"  class="btn btn-danger btn-sm "  onclick="return confirm('Are you sure you want to block user ?')">debloquer</i></a>
</td>
</tr>
