...
<?php while($row = $result -> fetch_assoc()):   ?>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <a onClick="window.location.reload();"  class="nav-link waves-effect waves-light"  ><i class="fas fa-sync-alt"></i>Actualliser
          ...
          <li class="nav-item">
 <a href="dashboard-validation-admin"  class="nav-link waves-effect waves-light" ><i class="fas fa-user-check"></i> validation</a>
          </li>
          <li class="nav-item">
...
<td>
  <?php 
     ...
     else{echo   '<a  href="#"  class="btn btn-secondary btn-sm" > valider</a>  ' ;  }    ?>
...
<script> function clic(){return confirm('vous etes sur   ?')
